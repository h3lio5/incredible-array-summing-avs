...
// Source: github.com/h3lio5/incredible-array-summing-avs/core/chainio (interfaces: AvsWriterer)
//
...
func (m *MockAvsWriterer) RaiseChallenge(arg0 context.Context, arg1 contractIncredibleSummingTaskManager.IIncredibleSummingTaskManagerTask, arg2 contractIncredibleSummingTaskManager.IIncredibleSummingTaskManagerTaskResponse, arg3 contractIncredibleSummingTaskManager.IIncredibleSummingTaskManagerTaskResponseMetadata, arg4 []contractIncredibleSummingTaskManager.BN254G1Point) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendAggregatedResponse(arg0 context.Context, arg1 contractIncredibleSummingTaskManager.IIncredibleSummingTaskManagerTask, arg2 contractIncredibleSummingTaskManager.IIncredibleSummingTaskManagerTaskResponse, arg3 contractIncredibleSummingTaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
// SendNewTaskArrayToSum mocks base method.
func (m *MockAvsWriterer) SendNewTaskArrayToSum(arg0 context.Context, arg1 [3]uint64, arg2 types.QuorumThresholdPercentage, arg3 types.QuorumNums) (contractIncredibleSummingTaskManager.IIncredibleSummingTaskManagerTask, uint32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendNewTaskArrayToSum", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(contractIncredibleSummingTaskManager.IIncredibleSummingTaskManagerTask)
	ret1, _ := ret[1].(uint32)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}

// SendNewTaskArrayToSum indicates an expected call of SendNewTaskArrayToSum.
func (mr *MockAvsWritererMockRecorder) SendNewTaskArrayToSum(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendNewTaskArrayToSum", reflect.TypeOf((*MockAvsWriterer)(nil).SendNewTaskArrayToSum), arg0, arg1, arg2, arg3)
}
