...
func (m *MockAvsWriterer) SendNewTaskNumberToSquare(arg0 context.Context, arg1 *big.Int, arg2 types.QuorumThresholdPercentage, arg3 types.QuorumNums) (contractIncredibleSummingTaskManager.IIncredibleSummingTaskManagerTask, uint32, error) {
	m.ctrl.T.Helper()
