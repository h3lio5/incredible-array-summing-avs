...
func (m *MockAvsSubscriberer) ParseTaskResponded(arg0 types.Log) (*contractIncredibleSummingTaskManager.ContractIncredibleSummingTaskManagerTaskResponded, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseTaskResponded", arg0)
	ret0, _ := ret[0].(*contractIncredibleSummingTaskManager.ContractIncredibleSummingTaskManagerTaskResponded)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAvsSubscriberer) SubscribeToNewTasks(arg0 chan *contractIncredibleSummingTaskManager.ContractIncredibleSummingTaskManagerNewTaskCreated) event.Subscription {
	m.ctrl.T.Helper()
...
func (m *MockAvsSubscriberer) SubscribeToTaskResponses(arg0 chan *contractIncredibleSummingTaskManager.ContractIncredibleSummingTaskManagerTaskResponded) event.Subscription {
	m.ctrl.T.Helper()
