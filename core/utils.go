...
// this hardcodes abi.encode() for cstaskmanager.IIncredibleSummingTaskManagerTaskResponse
// unclear why abigen doesn't provide this out of the box...
func AbiEncodeTaskResponse(h *cstaskmanager.IIncredibleSummingTaskManagerTaskResponse) ([]byte, error) {
